...
window.onload = function() {
    ...
    var buttons = [ { x: 30, y: 240, width: 150, height: 50, text: "Novo Jogo"},
                    { x: 30, y: 300, width: 150, height: 50, text: "Mostrar Dicas"},
                    { x: 30, y: 360, width: 150, height: 50, text: "Ativar Bot"}];
    ...
    function render() {
        ...
        drawCenterText("Pontos:", 30, level.y+40, 150);
        ...
        if (gameover) {
            ...
            context.font = "24px Verdana";
            drawCenterText("Fim de Jogo!", level.x, level.y + levelheight / 2 + 10, levelwidth);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Combine 3", 10, 30);
    }
        ...
        for (var i=0; i<buttons.length; i++) {
            if (pos.x >= buttons[i].x && pos.x < buttons[i].x+buttons[i].width &&
                ...
                if (i == 0) {
                    ...
                    // Show Moves
                    showmoves = !showmoves;
                    buttons[i].text = (showmoves?"Ocultar":"Mostrar") + " Dicas";
                } else if (i == 2) {
                    // AI Bot
                    aibot = !aibot;
                    buttons[i].text = (aibot?"Desativar":"Ativar") + " Bot";
                }
            }
        }
    }
