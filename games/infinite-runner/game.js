/**
 * Jogo original "Daily Pen #010: A generic Infinite Runner game",
 * criado por Eduardo Lopes (codepen.io/EduardoLopes). Licenca MIT
 * (ver LICENSE nesta pasta - copia arquivada da licenca do autor).
 * Usa a biblioteca sketch.js (MIT, Justin Windle - sketch.min.js).
 * Traduzido para pt-BR e adaptado para rodar como arquivo estatico
 * simples (removida a instrumentacao de protecao contra loop infinito
 * que o CodePen injeta automaticamente no preview).
 */
...
InfiniteRunner.draw = function () {
  ...
  this.fillText('RECORDE: ' + this.jumpCountRecord, this.width - (150 + this.aceleration * 4), 33 - this.aceleration * 4);
  this.fillStyle = this.scoreColor;
  this.font = 12 + this.aceleration * 3 + 'pt Arial';
  this.fillText('PULOS: ' + this.jumpCount, this.width - (150 + this.aceleration * 4), 50);
};
