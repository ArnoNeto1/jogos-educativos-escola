...
function engineInit(appInit, appUpdate, appUpdatePost, appRender, appRenderPost)
{
    ...
    tileImage.onload = ()=>
    {
        // aguarda o navegador reportar um tamanho de janela valido antes
        // de iniciar (protege contra abas criadas em segundo plano/
        // ocultas, onde innerWidth/innerHeight podem ser 0 no primeiro
        // frame, o que quebraria o canvas do WebGL)
        if (!innerWidth || !innerHeight)
        {
            requestAnimationFrame(()=>tileImage.onload());
            return;
        }
