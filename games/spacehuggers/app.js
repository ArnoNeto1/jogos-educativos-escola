...
()=> // appRenderPost
{
    ...
    p > 0 && mainContext.fillText('Um jogo da competição JS13K por Frank Force',mainCanvas.width/2, 210);
    ...
    mainContext.fillText('Fase ' + level + '      Vidas ' + playerLives + '      Inimigos ' + enemiesCount, mainCanvas.width/2, mainCanvas.height-40);
