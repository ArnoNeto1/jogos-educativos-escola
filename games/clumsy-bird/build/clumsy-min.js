// build/clumsy-min.js - gerado por concatenação (sem minificação) dos arquivos-fonte em js/,
// na mesma ordem definida pelo Gruntfile.js original do projeto (concat+uglify).
// Fontes traduzidas para pt-BR; ver comentários em js/*.js e js/screens/*.js.
    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                ...
                this.text = me.device.touch ? 'Toque para começar' : 'APERTE ESPAÇO OU CLIQUE COM O BOTÃO ESQUERDO PARA COMEÇAR \n\t\t\t\t\t\t\t\t\t\t\tAPERTE "M" PARA SILENCIAR O SOM';
...
game.PlayScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        // pt-BR: the original "getready" sprite baked "Get Ready!!" into a
        // PNG. Replaced with text drawn in the game's own "gamefont" so it
        // reads in Portuguese; `textAlpha` (a plain custom property, not the
        // renderable's built-in `alpha`) is what the fade-out tween below
        // drives, since me.Font manages its own opacity independently of the
        // wrapping me.Renderable.
        this.getReady = new (me.Renderable.extend({
            init: function() {
                this._super(me.Renderable, 'init', [0, 0, 100, 100]);
                this.text = 'PREPARE-SE!!';
                this.font = new me.Font('gamefont', 36, '#000', 'center');
                this.textAlpha = 1;
            },
            draw: function (renderer) {
                var prevAlpha = renderer.globalAlpha();
                renderer.setGlobalAlpha(this.textAlpha);
                this.font.draw(renderer, this.text, me.game.viewport.width/2, me.game.viewport.height/2);
        ...
        var that = this;
        var fadeOut = new me.Tween(this.getReady).to({textAlpha: 0}, 2000)
