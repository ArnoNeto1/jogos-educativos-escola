...
function showText(text) {
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>Jogo Pausado</div>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>Pressione Enter para começar</div>"
	};
