...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Toque nos lados esquerdo e direito'
        action_text = 'da tela para girar o hexágono'
        score_text = 'Combine 3+ blocos para pontuar'
        fontSize = 35
    } else {
        mob = false
        input_text = 'Use as setas direita e esquerda'
        action_text = 'para girar o hexágono'
        score_text = 'Combine 3+ blocos para pontuar!'
        fontSize = 27
    }
