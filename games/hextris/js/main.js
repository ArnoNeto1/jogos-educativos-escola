...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>COMO JOGAR</div><p>O objetivo do Hextris é impedir que os blocos saiam de dentro do hexágono cinza externo.</p><p>" + (settings.platform != 'mobile' ? 'Pressione as setas direita e esquerda do teclado' : 'Toque nos lados esquerdo e direito da tela') + " para girar o hexágono." + (settings.platform != 'mobile' ? ' Pressione a seta para baixo para acelerar a queda dos blocos.': '') + " </p><p>Elimine blocos e ganhe pontos formando grupos de 3 ou mais blocos da mesma cor encostando um no outro.</p><p>O tempo restante da sua sequência de combo é indicado pelas <span style='color:#f1c40f;'>linhas</span> <span style='color:#e74c3c'>coloridas</span> <span style='color:#3498db'>no</span> <span style='color:#2ecc71'>hexágono</span> externo.</p> <hr> <p id = 'afterhr'></p> Jogo original de <a href='http://loganengstrom.com' target='_blank'>Logan Engstrom</a> & <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a><br>Mais informações no <a href ='http://hextris.github.io/' target='_blank'>site do Hextris</a>");
	if (gameState == 1) {
		pause();
	}
