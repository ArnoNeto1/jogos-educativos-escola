...
// Pista extra "facil": um retangulo simples e curto (menos peças = corrida mais rapida e previsivel).
export const TRACK_CELLS_FACIL = [
	[ 0, 0, 'track-corner',   16 ],
	[ 1, 0, 'track-straight', 22 ],
	[ 2, 0, 'track-straight', 22 ],
	[ 3, 0, 'track-corner',    0 ],
	[ 3, 1, 'track-straight',  0 ],
	[ 0, 1, 'track-finish',    0 ],
	[ 3, 2, 'track-corner',   22 ],
	[ 2, 2, 'track-straight', 22 ],
	[ 1, 2, 'track-straight', 22 ],
	[ 0, 2, 'track-corner',   10 ],
];

// Pista extra "dificil": um retangulo maior (mais peças = volta mais longa e desafiadora).
export const TRACK_CELLS_DIFICIL = [
	[ 0, 0, 'track-corner',   16 ],
	[ 1, 0, 'track-straight', 22 ],
	[ 2, 0, 'track-straight', 22 ],
	[ 3, 0, 'track-straight', 22 ],
	[ 4, 0, 'track-straight', 22 ],
	[ 5, 0, 'track-corner',    0 ],
	[ 5, 1, 'track-straight',  0 ],
	[ 5, 2, 'track-straight',  0 ],
	[ 5, 3, 'track-corner',   22 ],
	[ 4, 3, 'track-straight', 22 ],
	[ 3, 3, 'track-straight', 22 ],
	[ 2, 3, 'track-straight', 22 ],
	[ 1, 3, 'track-straight', 22 ],
	[ 0, 3, 'track-corner',   10 ],
	[ 0, 2, 'track-straight',  0 ],
