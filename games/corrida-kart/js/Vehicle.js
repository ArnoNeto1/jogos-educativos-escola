...
export let MAX_SPEED = 1.5;

// Permite ajustar a velocidade maxima por nivel de dificuldade (chamado antes de iniciar a corrida).
export function setMaxSpeed( valor ) {
